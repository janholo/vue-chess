<template>
  <div class="figure" v-bind:class="{ white: IsWhiteBackground() }">
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 45 45">
      ...
      <text x="1" y="10" font-size="12" v-bind:fill="IsWhiteBackground() ? '#e6e6e6' : '#999999'" v-bind:stroke="IsWhiteBackground() ? '#e6e6e6' : '#999999'" >{{field.name}}</text>
      <!-- white king //-->
      <g
      ...
      >
        ...
        <path
          ...
          style="fill:#ffffff; "
        />
        <path d="M 11.5,30 C 17,27 27,27 32.5,30" style="fill:none; " />
        <path d="M 11.5,33.5 C 17,30.5 27,30.5 32.5,33.5" style="fill:none; " />
        <path d="M 11.5,37 C 17,34 27,34 32.5,37" style="fill:none; " />
      </g>

      <!-- white queen //-->
      <g
        style="opacity:1; fill:#ffffff; fill-opacity:1; fill-rule:evenodd; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;"
        v-if="IsWhite() && IsQueen()"
      >
      ...
      <!-- white bishop //-->
      <g
        style="opacity:1; fill:none; fill-rule:evenodd; fill-opacity:1; stroke-width:1.5; stroke-linecap:round; stroke-linejoin:round; stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;"
        v-if="IsWhite() && IsBishop()"
      >
        <g style="fill:#ffffff; stroke-linecap:butt;">
          <path
      ...
      <!-- white knight //-->
      <g
        style="opacity:1; fill:none; fill-opacity:1; fill-rule:evenodd; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;"
        v-if="IsWhite() && IsKnight()"
      >
        <path
      ...
      >
        ...
        <path d="M 11,14 L 34,14" style="fill:none; stroke-linejoin:miter;" />
      </g>

      <!-- white pawn //-->
      <g v-if="IsWhite() && IsPawn()">
        <path
          d="M 22,9 C 19.79,9 18,10.79 18,13 C 18,13.89 18.29,14.71 18.78,15.38 C 16.83,16.5 15.5,18.59 15.5,21 C 15.5,23.03 16.44,24.84 17.91,26.03 C 14.91,27.09 10.5,31.58 10.5,39.5 L 33.5,39.5 C 33.5,31.58 29.09,27.09 26.09,26.03 C 27.56,24.84 28.5,23.03 28.5,21 C 28.5,18.59 27.17,16.5 25.22,15.38 C 25.71,14.71 26,13.89 26,13 C 26,10.79 24.21,9 22,9 z "
          style="opacity:1; fill:#ffffff; fill-opacity:1; fill-rule:nonzero; stroke-width:1.5; stroke-linecap:round; stroke-linejoin:miter; stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;"
        />
      </g>

      <!-- black king //-->
      <g
        style="fill-opacity:1; fill-rule:evenodd; stroke-width:1.5; stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4; stroke-dasharray:none; stroke-opacity:1;"
        v-if="IsBlack() && IsKing()"
      >
        <path d="M 22.5,11.63 L 22.5,6" style="fill:none; stroke-linejoin:miter;" />
        <path
...
export default class ChessField extends Vue {
  ...
  IsBlack() {
    return this.field.piece != undefined && this.field.piece.color == Color.Black;
  }
  IsWhite() {
  ...
  IsBishop() {
    return this.field.piece != undefined && this.field.piece.kind == Kind.Bishop;
  }
  IsRook() {
  ...
  IsKnight() {
    return this.field.piece != undefined && this.field.piece.kind == Kind.Knight;
  }
}
</script>
